...
const testSteps = [
  {
    ...
    status: "success",
    details: [
      { node: "10.39.239.237:27018", state: "SECONDARY", health: 1, note: "" },
      { node: "10.39.239.119:27018", state: "PRIMARY", health: 1, note: "" },
      { node: "10.39.239.232:27018", state: "SECONDARY", health: 1, note: "" },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    status: "success",
    newState: [
      { node: "10.39.239.237:27018", state: "PRIMARY", health: 1, note: "Nouveau PRIMARY élu!" },
      { node: "10.39.239.119:27018", state: "(not reachable)", health: 0, note: "Ancien PRIMARY arrêté" },
      { node: "10.39.239.232:27018", state: "SECONDARY", health: 1, note: "SECONDARY actif" },
    ],
  },
  {
    id: 4,
